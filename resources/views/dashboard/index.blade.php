							...
							<td>
								<div class="dropdown select-status">
									...
									<ul class="dropdown-menu dropdown-menu-end">
										...
										<li><a class="dropdown-item" data-selected="true">Approved</a></li>
							...
							<td>
								<div class="dropdown select-status">
									...
									<ul class="dropdown-menu dropdown-menu-end">
										<li><a class="dropdown-item">Pending</a></li>
										<li><a class="dropdown-item">Approved</a></li>
										<li><a class="dropdown-item" data-selected="true">Rejected</a></li>
									</ul>
								</div>
							</td>
						</tr>
